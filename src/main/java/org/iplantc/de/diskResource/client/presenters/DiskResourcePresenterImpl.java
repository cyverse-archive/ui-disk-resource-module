...
public class DiskResourcePresenterImpl implements DiskResourceView.Presenter {
    ...
    public DiskResourcePresenterImpl(final DiskResourceView view, final DiskResourceView.Proxy proxy,
        ...
        this.dataSearchPresenter.searchInit(getView(), getView(), this, getView().getTreeStore(),
                getView().getToolbar().getSearchField());
    ...
    public void doBulkDownload() {
        EventBus.getInstance().fireEvent(
                new RequestBulkDownloadEvent(this, view.isSelectAll(), getSelectedDiskResources(),
                        getSelectedFolder()));
    }
